...
contract KumatoNFT is Initializable, ERC721URIStorageUpgradeable, EIP712Upgradeable, AccessControlUpgradeable {
  bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  string private constant SIGNING_DOMAIN = "KumatoNFT-Voucher";
  ...
  //   ERC721("KumatoNFT", "LAZ") 
  //   EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION) {
  //     _setupRole(MINTER_ROLE, minter);
  //   }

  function __KumatoNFT_init(address payable minter) public initializer {
    __ERC721_init("KumatoNFT", "LAZ");
